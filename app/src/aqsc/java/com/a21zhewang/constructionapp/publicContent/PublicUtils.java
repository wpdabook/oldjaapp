...
public class PublicUtils {
    ...
    //=================================常用链START=====================================================//
      ...
      public  static String URLload="https://whdc-safe.telsafe.com.cn:8889";//全局urL
      public  static String URL = URLload +"/API/SGGL.aspx";//全局url
      public  static Boolean IS_DEBUG_MODE = false;    //调试模式设置
      public  static String ALIAS="WHC_";
      /**部分模块切换市局服务器*/
...
//     /**武汉地产控股测试*/
//     public  static String HTMLURL="http://106.15.92.195:9002";
//     public  static String URLload="https://whdc-safe.telsafe.com.cn:8001";//全局urL
//     public  static String URL = URLload +"/API/SGGL.aspx";//全局url
//     public  static Boolean IS_DEBUG_MODE = false;    //调试模式设置
//     public  static String ALIAS="WHC_";
...
//      /**武汉地产控股老服务器地址正式*/
//      public  static String HTMLURL="http://106.15.92.195:9002";
//      public  static String URLload="https://wuhan.21theone.cn:8001";//全局urL
//      public  static String URL = URLload +"/API/SGGL.aspx";//全局url
