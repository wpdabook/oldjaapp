...
public abstract class Act_TaskBaseListView<A, B, C> extends BaseActivity implements OnTouchUpListener {
    ...
    public int getLayoutId() {
        return R.layout.act_taskbase_layout;
    }
    ...
    public void initViews() {
        /***简易告知没有发起功能*/
        //ctivityBaselistviewRelativeLayout.setVisibility(View.GONE);
        ...
        commonAdapter = new CommonAdapter<C>(this,
                R.layout.act_task_list_item_layout, listBeenlist) {
