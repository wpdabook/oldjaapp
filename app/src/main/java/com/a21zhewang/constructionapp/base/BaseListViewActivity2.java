...
public abstract class BaseListViewActivity2<A, B, C> extends BaseActivity implements OnTouchUpListener {
   ...
   public SearchView SearchView_top;//子下拉
    ...
    public int getLayoutId() {
        return R.layout.activity_baselistview;
    }
    ...
    public void initViews() {
        ...
        commonAdapter = new CommonAdapter<C>(this,
                R.layout.common_adapter_item, listBeenlist) {
