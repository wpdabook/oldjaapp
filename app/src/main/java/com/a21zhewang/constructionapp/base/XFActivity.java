...
public class XFActivity extends BaseActivity {
    ...
    @BindView(R.id.activity_zf2_MyTitleBar)
    MyTitleBar activityZf2MyTitleBar;
    ...
    public void initViews() {
        activityZf2MyTitleBar.setTitlenametv("下发");
        ...
        activityZf2LinkageSpinner.setMaxETPCount(1);
    }
    ...
    public void initListener() {
        ...
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"btnID\":\"cmBtn8\",\"recordID\":\"" + msgid + "\"}"),
                getCoordinateMsgTransmit, new MyCallBack() {
                    ...
                    public void onResule(String res) {
                        ...
                        List<Etp> transEtpList = addgtxtinitBean.getEtpList();
    ...
    public void postdata(String str, String names) {
        ...
        JSONObject getjsonobj = JsonUtils.getjsonobj("{\"createUserName\":\"" + PublicUtils.userBean.getUserName() + "\",\"receivers\":" + names + ",\"dealContent\":\"" + str + "\",\"btnID\":\"cmBtn8\",\"createUserID\":\"" + PublicUtils.UserID + "\",\"recordID\":\"" + msgid + "\"}");
