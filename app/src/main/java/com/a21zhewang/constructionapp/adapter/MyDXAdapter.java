...
public class MyDXAdapter extends BaseAdapter{

	private Context context = null;
	private List<JdzfStatus> datas = null;
	/**
	 * CheckBox 是否选择的存储集合,key 是 position , value 是该position是否选中
	 */
	private Map<Integer, Boolean> isCheckMap = new HashMap<Integer, Boolean>();

	public MyDXAdapter(Context context, List<JdzfStatus> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View view, ViewGroup parent) {
		JdzfStatus JdzfStatus = datas.get(position);
		...
		tvTitle.setText(JdzfStatus.getTypeName());
...
//		}
	 ...
	 * 增加一项的时候
	 */
	public void add(JdzfStatus JdzfStatus) {
		this.datas.add(0, JdzfStatus);
		// 让所有项目都为不选择
		initDate(false);
	}
