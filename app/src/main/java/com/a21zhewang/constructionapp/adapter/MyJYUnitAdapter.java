...
public class MyJYUnitAdapter extends BaseAdapter{

	private Context context = null;
	private List<JygzUnit> datas = null;
	/**
	 * CheckBox 是否选择的存储集合,key 是 position , value 是该position是否选中
	 */
	private Map<Integer, Boolean> isCheckMap = new HashMap<Integer, Boolean>();

	public MyJYUnitAdapter(Context context, List<JygzUnit> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View view, ViewGroup parent) {
		JygzUnit jygzUnit = datas.get(position);
		...
		tvTitle.setText(jygzUnit.getEtpTypeName());
...
//		}
	 ...
	 * 增加一项的时候
	 */
	public void add(JygzUnit jygzUnit) {
		this.datas.add(0, jygzUnit);
		// 让所有项目都为不选择
		initDate(false);
	}
