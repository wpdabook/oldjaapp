...
public class SelectCompanyAdapter extends BaseExpandableListAdapter implements ExpandableListView.OnChildClickListener{
    private Context context;
    private List<TaskBean> TaskBeanList;
    private List<TaskCompany> childgroups;

    public SelectCompanyAdapter(Context context, List<TaskBean> groups) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.adapter_selectcompany_group_layout, null);
        }
        ...
        checkBox.setOnClickListener(new SelectCompanyAdapter.Group_CheckBox_Click(groupPosition));
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.adapter_selectcompany_child_layout, null);
        }
        ...
        // 點擊 CheckBox 時，將狀態存起來
        checkBox.setOnClickListener(new SelectCompanyAdapter.Child_CheckBox_Click(groupPosition, childPosition));
