...
public class MyScaffoldAdapter extends BaseAdapter {

	private Context context = null;
	private List<ScaffoldData> datas = null;
	...
	public MyScaffoldAdapter(Context context, List<ScaffoldData> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View view, ViewGroup parent) {
		final ScaffoldData scaffoldData = datas.get(position);
		...
		tvTitle.setText(scaffoldData.getConfigName());
...
//		}
	 ...
	 * 增加一项的时候
	 */
	public void add(ScaffoldData scaffoldData) {
		this.datas.add(0, scaffoldData);
		// 让所有项目都为不选择
		initDate(false);
	}
