...
public class EtpAdapter extends BaseAdapter{

    private Context context = null;
    private List<EptBean> datas = null;
    /**
     * CheckBox 是否选择的存储集合,key 是 position , value 是该position是否选中
     */
    private Map<Integer, Boolean> isCheckMap = new HashMap<Integer, Boolean>();

    public EtpAdapter(Context context, List<EptBean> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        EptBean eptBean = datas.get(position);
        ...
        tvTitle.setText(eptBean.getUserName());
...
//		}
     ...
     * 增加一项的时候
     */
    public void add(EptBean eptBean) {
        this.datas.add(0, eptBean);
        // 让所有项目都为不选择
        initDate(false);
    }
