...
public class UnitAdapter extends BaseAdapter{
    ...
    private List<JygzUnitInfo> datas = null;
    /**
     * CheckBox 是否选择的存储集合,key 是 position , value 是该position是否选中
     */
    private Map<Integer, Boolean> isCheckMap = new HashMap<Integer, Boolean>();

    public UnitAdapter(Context context, List<JygzUnitInfo> datas) {
        this.datas = datas;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        JygzUnitInfo jygzUnitInfo = datas.get(position);
        ...
        tvTitle.setText(jygzUnitInfo.getEtpShortName());
...
//		}
     ...
     * 增加一项的时候
     */
    public void add(JygzUnitInfo jygzUnitInfo) {
        this.datas.add(0, jygzUnitInfo);
        // 让所有项目都为不选择
        initDate(false);
    }
