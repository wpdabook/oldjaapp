 ...
 * 时间：2016/5/13
 */
public class ZddbDetailAdapter extends BaseAdapter {

    private Context mContext;
    private List<ZddbInfoBean> mList;
    protected LayoutInflater inflater;

    public ZddbDetailAdapter(Context context) {
        mContext = context;
        inflater = LayoutInflater.from(context);
    }

    public void setList(List<ZddbInfoBean> list) {
        mList = list;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || convertView.getTag() == null) {
            convertView = inflater.inflate(R.layout.act_zddb_detail_adapter_item, parent, false);
...
//        }
    ...
    private int getListSize(List<ZddbInfoBean> list) {
