...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        textPaintNum=new Paint();
        textPaintNum.setStyle(Paint.Style.FILL);
        textPaintNum.setStrokeWidth(5);
        textPaintNum.setTextSize(30);
        textPaintNum.setColor(getResources().getColor(R.color.color_666666));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float distance=(fontMetrics.bottom - fontMetrics.top)/4 - fontMetrics.bottom;
        float distance2=(fontMetrics.bottom - fontMetrics.top)/1 - fontMetrics.bottom;
        float baseline=mRectF.centerY()+ distance;
        canvas.drawText(title_text, mRectF.centerX(), baseline, textPaint);
        canvas.drawText(title_num, mRectF.centerX(), mRectF.centerY()+distance2, textPaintNum);
     ...
     *
     */
    public void setText(String str_text,String num) {
        this.title_text = str_text;
        this.title_num = num;
        invalidate();
    }
    /**
