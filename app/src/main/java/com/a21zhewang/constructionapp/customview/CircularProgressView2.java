...
public class CircularProgressView2 extends View {
    ...
    public CircularProgressView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularProgressView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     *
     */
    public void setText(String str_text) {
