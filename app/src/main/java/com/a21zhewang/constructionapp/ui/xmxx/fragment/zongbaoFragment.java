...
public class zongbaoFragment extends BaseFragment implements ISetData{

    @BindView(R.id.zongbaoFragment_ExpandableListView)
    ExpandableListView expandableListView;

    public zongbaoFragment() {
     ...
     *
     * @return A new instance of fragment zongbaoFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static zongbaoFragment newInstance() {
        zongbaoFragment fragment = new zongbaoFragment();
        return fragment;
    }
    ...
    public int getLayoutId() {
        return R.layout.fragment_zongbao;
    }
...
//        });
    ...
    public void setData(FbBean fbBean) {
        List<FbBean.EtpInfoListBean> etpInfoList = fbBean.getZongbaoEtpInfoList();
        if (etpInfoList != null && etpInfoList.size() > 0) {
            expandableListView.setAdapter(new FbAdapter(getActivity(), etpInfoList) {
                ...
                public void initChildviewholder(FbBean.EtpInfoListBean.UserInfoListBean userInfoListBean, Childviewholder childviewholder) {
                    ...
                    String userType = userInfoListBean.getUserType();
//                            if (userType!=null)
//                                childviewholder.tv4.setText(userType);
//                            childviewholder.tv4.setVisibility(View.VISIBLE);
