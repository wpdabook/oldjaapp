...
public class Act_AddTypeProceduralReback extends BaseActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    public int getLayoutId() {
        return R.layout.act_addtype_procedural_reback;
    }
...
//        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.item_spinner_defalut,spinnerlist);
        adapter = new ArrayAdapter<String>(Act_AddTypeProceduralReback.this,R.layout.item_spinner_defalut,spinnerlist);
...
//                            remove(getData().size()-1);
    ...
    public void initAlert(){
        new ActionSheetDialog(Act_AddTypeProceduralReback.this)
                .builder()
                .setCancelable(false)
    ...
    public void PictureSelector(){
        PictureSelector.create(Act_AddTypeProceduralReback.this).openGallery(PictureMimeType.ofImage())
                .maxSelectNum(9)
                .imageSpanCount(4)
    ...
    public void PictureCarmerSelector(){
        PictureSelector.create(Act_AddTypeProceduralReback.this).openCamera(PictureMimeType.ofImage())
                .maxSelectNum(9)
                .imageSpanCount(4)
                .selectionMode(PictureConfig.MULTIPLE)
                .previewImage(true)
...
//                showToast("保存成功");
                ...
                Act_AddTypeProceduralReback.this.finish();
            }
            @Override
            public void onFail(ObjBean getbean) {
...
//                showToast("保存成功");
                    ...
                    if(path != null){
                        if(selectTag == 1){
                            if(TextUtils.isEmpty(xPoint) && TextUtils.isEmpty(yPoint)){
                                Bitmap bitmap = SendImageUtil.createWatermark(Act_AddTypeProceduralReback.this,
    ...
    public void getLocation(){
        Location location = LocationUtils.getInstance(Act_AddTypeProceduralReback.this ).showLocation();
        if (location != null) {
