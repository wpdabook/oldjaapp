...
import com.a21zhewang.constructionapp.bean.Cluster;
 ...
 */
public class MyClusterOverlay implements AMap.OnCameraChangeListener,
     ...
     * @param context
     */
    public MyClusterOverlay(AMap amap, int clusterSize, Context context) {
     ...
     * @param context
     */
    public MyClusterOverlay(AMap amap, List<ClusterItem> clusterItems,
...
//                textView.setText("附近有\n"+tile+"个"+"\n坐标");
                ...
                if (mClusterRender != null && mClusterRender.getDrawAble(mCluster.getClusterCount()) != null) {
                    ...
                    textView.setBackgroundResource(R.drawable.map_locationname_bg);
                }
