package com.a21zhewang.constructionapp.ui.repository;
...
public class RepositoryActivity extends BaseActivity {
    ...
    @BindView(R.id.activity_resy_MyTitleBar)
    MyTitleBar activityGtxtMyTitleBar;

    @BindView(R.id.res_webview)
    WebView webview;
    ...
    public void initViews() {
        ...
        if(!TextUtils.isEmpty(title)){
            activityGtxtMyTitleBar.setTitlenametv(title);
        }
