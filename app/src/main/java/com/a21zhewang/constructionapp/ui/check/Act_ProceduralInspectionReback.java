...
public class Act_ProceduralInspectionReback extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.act_procedural_inspection_reback;
    }
    ...
    public void initViews() {
        ...
        adapter = new ProceInspectAdapter(Act_ProceduralInspectionReback.this);
...
//                   Act_ProceduralInspection.this.finish();
    ...
    private class ProceInspectAdapter extends FreeAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            view = LayoutInflater.from(context).inflate(R.layout.act_procedural_inspecation_reback_item, null);
            TextView name =  findViewById(view,R.id.check_item_name);
            TextView problem = findViewById(view,R.id.check_item_problem);
            final RadioGroup radioGroup = findViewById(view,R.id.radiogroup);
...
//                @Override
//                public void onClick(View v) {
//                    Intent i = new Intent(Act_ProceduralInspectionReback.this, Act_AddTypeProcedural.class);
...
//            });
            ...
            problem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(Act_ProceduralInspectionReback.this,Act_ProceduralProblem.class)
                            .putExtra("recordId",recordId)
                            .putExtra("sectionId",sectionId)
                            .putExtra("itemID",recordList.get(position).getItemID()));
                }
            ...
            itemLayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivityForResult(new Intent(Act_ProceduralInspectionReback.this,Act_HistoryDetail.class)
                            .putExtra("recordId",recordId)
            ...
            radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
                    ...
                    if(rb2.isChecked()){
                        ...
                        Intent i = new Intent(Act_ProceduralInspectionReback.this, Act_AddTypeProceduralReback.class);
                        i.putExtra("position", position)
                                .putExtra("projectID", projectID)
                                .putExtra("recordId", recordId)
                                .putExtra("typeName", typeName)
                                ...
                                .putExtra("itemID", recordList.get(position).getItemID())
                                .putExtra("proShortName", proShortName);
                        startActivityForResult(i, REBACK_REQUESTCODE);
