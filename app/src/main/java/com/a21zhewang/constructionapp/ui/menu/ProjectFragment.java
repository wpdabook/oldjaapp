...
//                subcolumnValue.setLabel((float) d.doubleValue()+"%未检查");
//            }else {
//                subcolumnValue.setLabel((float) d.doubleValue()+"%已检查");
//            }
...
//        }
    ...
    private class ChartValueTouchListener implements PieChartOnValueSelectListener {
        ...
        public void onValueSelected(int arcIndex, SliceValue value) {
            ...
            if (value.getValue() != -1) {
                if (index == 0) {
                    startActivity(new Intent(getActivity(), Act_SafetyQualityCivilization.class) //安全
                            .putExtra("projectName", projectName)
                            .putExtra("projectId", projectId)
                            .putExtra("rectType", 1));
                }
                if (index == 1) {
                    startActivity(new Intent(getActivity(), Act_SafetyQualityCivilization.class) //质量
                            .putExtra("projectName", projectName)
                            .putExtra("projectId", projectId)
                            .putExtra("rectType", 2));
                }
                if (index == 2) {
                    startActivity(new Intent(getActivity(), Act_SafetyQualityCivilization.class)//文明
                            .putExtra("projectName", projectName)
                            .putExtra("projectId", projectId)
                            .putExtra("rectType", 3));
                }
