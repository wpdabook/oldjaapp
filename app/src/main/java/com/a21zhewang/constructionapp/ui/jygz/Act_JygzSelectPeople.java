...
public class Act_JygzSelectPeople extends BaseActivity {

    @BindView(R.id.lvListView)
    ListView listview;
    public final static int RESQUST_CODE_SELECTTYPE=5290;
    /*执法类别*/
    private JygzUnitInfo jygzUnitInfo;
    private List<EptBean> eptBeanList = new ArrayList<>();
    private EtpAdapter adapter = null;
    ...
    public void initListener() {
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                data.putExtra("userName",eptBeanList.get(position).getUserName());
                data.putExtra("userId",eptBeanList.get(position).getUserId());
            ...
            public void onResule(String res) {
                ...
                try {
                    ...
                    for(int i=0;i<array.length();i++){
                        ...
                        eptBeanList = JsonUtils.jsonToList(temparray.toString(),EptBean[].class);
                        adapter = new EtpAdapter(Act_JygzSelectPeople.this, eptBeanList);
