...
public class Act_RcjdReplyDetail extends BaseActivity{
    ...
    private void loadData(boolean needDialog) {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"id\":\"" + id + "\",\"pageIndex\":\"" +  String.valueOf(page) + "\",\"pageSize\":\"" +  10 + "\"}"), "GetDaySuperviseManager_ReplyList", new MyCallBack() {
...
//                    initListData();
                    ...
                    if (page > totalPage) {
                        ...
                        Toast.makeText(Act_RcjdReplyDetail.this, "已无更多数据", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    if(object.length()>0){
