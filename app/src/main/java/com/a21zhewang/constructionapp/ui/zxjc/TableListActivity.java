        ...
        submitbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(json)) {
                    postdata(JsonUtils.getjsonobj(json), "AddSpecialExamination");
                } else {
                ...
                switch (helper.getItemViewType()) {
                    ...
                    case 1:
                        ...
                        helper.getView(R.id.need_dispose_question_look).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (errorMsgList.size() > 0) {
                                    Intent intent = new Intent(TableListActivity.this, SuspendingQuestionActivity.class);
                        ...
                        helper.getView(R.id.check_item_addNewCheck).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                checks.add(item);
                                Intent intent = new Intent(mContext, NewCheckQuestionActivity.class);
