...
public class ZljdActivity extends BaseListViewActivity<
...
//                        holder.setText(R.id.gtxt_list_item_tv_msgTypeID, otherBean.getMsgTypeID());
        ...
        holder.setText(R.id.gtxt_list_item_tv_msgTitle, "标题："+zljdspinnerBean.getTitle());
...
//        gradientDrawable.setColor(Color.parseColor(color_str));
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ZljdActivity.this, ZljdxqActivity.class);
    ...
    public void setaddbtnonclick() {
        activityBaselistviewRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickIndex=0;
                startActivity(new Intent(ZljdActivity.this,ZljdAddActivity.class));
            }
        });
    }
    ...
    private void getlistdata(int pageIndex,int pageSize) {
        ...
        XUtil.postjsondata(getjsonobj, "GetListQualityMsg", new MyCallBack() {
            @Override
            public void onResule(String res) {
                try {
