...
public class SetCheckChildActivity extends BaseActivity {
    ...
    public void initData() {
        ...
        if (SetCheckListActivity.checkType.getCheckItemList() != null) {
            checkItemAdapter = new CheckItemAdapter(SetCheckChildActivity.this, SetCheckListActivity.checkType.getCheckItemList());
            activity_set_check_child_RecyclerView.setAdapter(checkItemAdapter);
        }
        else {
            getlistdata(SetCheckListActivity.checkType.getDicID());
        }
    ...
    private void getlistdata(String dicID) {
        ...
        XUtil.postjsondata(getjsonobj, "SpecialExaminationInitialize", new MyCallBack() {
            ...
            public void onResule(String res) {
                ...
                checkItemAdapter = new CheckItemAdapter(SetCheckChildActivity.this,
                        SetCheckListActivity.checkType.getCheckItemList());
                activity_set_check_child_RecyclerView.setAdapter(checkItemAdapter);
