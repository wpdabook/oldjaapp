...
public class InspectionFragment extends Fragment{
    ...
    public void refresh() {
        MobclickAgent.onPageStart("专项巡查");
        page = 0;
...
//                        tv_sort.setText(sortnum+"");
                        ...
                        type.setText("检查类型："+object.optString("checkCategory"));
                        if("2".equals(status)){
                            rate.setText("推送时间："+object.optString("createTime"));
                        }else {
                            rate.setText("检查时间："+object.optString("checkTime"));
                        }
//                        risk_number.setText("检查类别："+object.optString("approveType"));
...
//                        number.setText(df.format(object.optDouble("sore"))+"分");
    ...
    private NoDoubleClickListener noDoubleClickListener = new NoDoubleClickListener() {
        ...
        void onNoDoubleClick(View v) {
            ...
            i.putExtra("approveType",object.optString("approveType"));
...
//            tempButton.setPadding(25, 10, 25, 10);
    ...
    private void loadData(boolean needDialog, String listType, int listStatus) {
        JSONObject object = JsonUtils.getjsonobj("{\"listType\":\"" + listType + "\",\"keyword\":\"" + ((Act_Inspection)getActivity()).getKeyWord()  + "\",\"listStatus\":\"" + listStatus +  "\"," +
        ...
        if("com.a21zhewang.constructionapp3".equals(AppUtils.getPackageName(getActivity()))
                || "com.a21zhewang.constructionapp.cqjg".equals(AppUtils.getPackageName(getActivity()))){
