...
public class SitePersonnelFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sitepersion_fragment, container, false);
        listView = (ListView) view.findViewById(R.id.bottom_listview);
        areaKey = ((Act_Menu)getActivity()).getAreaKey();
        final LinearLayout more = (LinearLayout)view.findViewById(R.id.lin_more5);
        adapter = new MyBaseAdapter() {
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                if (view == null) {
                    view = getActivity().getLayoutInflater().inflate(R.layout.sitepersionnel_fragment_item, null);
                }
                ...
                if(object.length()>0){
                    ...
                    project_number.setText(object.optInt("configUserNum")+"");
                    today_risk_number.setText(object.optInt("makeUserNum")+"");
                    total_risk_number.setText(object.optInt("abnorUserNum")+"");
                    risk_rote.setText(object.optDouble("keyPostRate")+"%");
                }
        ...
        more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),Act_CityMoreInfo.class).putExtra("type",2).putExtra("title","现场人员情况").putExtra("areaKey",areaKey));
            }
        });
    ...
    protected void loadData(String method) {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"type\":\"" + "2" + "\",\"areaKey\":\"" + ((Act_Menu)getActivity()).getAreaKey() + "\"" +
