...
public class WdSuspendingQuestionActivity extends BaseActivity {
    ...
    public void initViews() {
                 ...
                 helper.itemView.setOnClickListener(new View.OnClickListener() {
                  ...
                  //       PublicUtils.toast("点击了");
                         ...
                         if ("SG_SafetyMsg".equals(method)) {//安全检查
                             Intent intent=new Intent(WdSuspendingQuestionActivity.this, AqscxqActivity.class);
                             intent.putExtra("recordID",item.getRelationID());
                             startActivity(intent);
                         } else if ("SG_QualityMsg".equals(method)) {//质量检查
                             Intent intent=new Intent(WdSuspendingQuestionActivity.this, ZljdxqActivity.class);
                             intent.putExtra("recordID",item.getRelationID());
                             startActivity(intent);
                         } else if ("SG_CivilizedMsg".equals(method)) {//文明施工
                             Intent intent=new Intent(WdSuspendingQuestionActivity.this, WmsgxqActivity.class);
                             intent.putExtra("recordID",item.getRelationID());
                             startActivity(intent);
                         }
                     }
        ...
        activitySuspendingQuestionRecyclerView.addItemDecoration(new WdSimpleDividerDecoration("#ededed",1));
