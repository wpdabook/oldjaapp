...
public class HelpWordActivity extends BaseActivity{
    @BindView(R.id.helpword_xlistview)
    XListView mListView;
    private int page = 0;
    ...
    public int getLayoutId() {
        return R.layout.helpword_layout;
    }
    ...
    public void initViews() {
        ...
        adapter = new MyBaseAdapter() {
            ...
            public View getView(int position, View arg1, ViewGroup parent) {
                ...
                if (arg1 == null) {
                    arg1 = getLayoutInflater().inflate(R.layout.helpword_item_layout, null);
                }
                arg1.setVisibility(View.VISIBLE);
                TextView info = MViewHolder.get(arg1, R.id.info);
                TextView request = MViewHolder.get(arg1, R.id.request);
                if(object.length()>0){
                    info.setText(object.optString("question"));
                    request.setText(object.optString("answer"));
                }
    ...
    private void loadData(boolean needDialog) {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"pageIndex\":\"" +  String.valueOf(page) + "\",\"pageSize\":\"" +  10 + "\"}"), "getHelpingDocument", new MyCallBack() {
            ...
            public void onResule(String res) {
                try {
                    ...
                    if (page > totalPage) {
                        ...
                        Toast.makeText(HelpWordActivity.this, "已无更多数据", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    if(object.length()>0){
