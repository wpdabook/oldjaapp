...
public class CriticalProjectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.critical_project_fragment,container,false);
    ...
    protected void loadData() {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"type\":\"" + 3 + "\",\"areaKey\":\"" + ((Act_Menu)getActivity()).getAreaKey() + "\"}"), "GetCitySiteTrend", new MyCallBack() {
...
//                            "}";
                    ...
                    JSONArray array = object.optJSONArray("dangerList");
                    generateData(array);
    ...
    private void generateData(JSONArray array) {
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            SliceValue sliceValue = new SliceValue(object.optInt("dangerTotal"), colors[i]);
            if (i < 3) {
                lin_one_line.setVisibility(View.VISIBLE);
                lin_one.setVisibility(View.VISIBLE);
                tag_01.setText(array.optJSONObject(0).optString("dangerName"));
                if (i == 1) {
                    lin_two.setVisibility(View.VISIBLE);
                    tag_02.setText(array.optJSONObject(1).optString("dangerName"));
                } else if (i == 2) {
                    lin_two.setVisibility(View.VISIBLE);
                    lin_three.setVisibility(View.VISIBLE);
                    tag_02.setText(array.optJSONObject(1).optString("dangerName"));
                    tag_03.setText(array.optJSONObject(2).optString("dangerName"));
                }
            } else if (i >= 3 && i < 6) {
                lin_one_line.setVisibility(View.VISIBLE);
                ...
                tag_02.setText(array.optJSONObject(1).optString("dangerName"));
                tag_03.setText(array.optJSONObject(2).optString("dangerName"));
                tag_04.setText(array.optJSONObject(3).optString("dangerName"));
                if (i == 4) {
                    lin_five.setVisibility(View.VISIBLE);
                    tag_05.setText(array.optJSONObject(4).optString("dangerName"));
                } else if (i == 5) {
                    lin_five.setVisibility(View.VISIBLE);
                    lin_sex.setVisibility(View.VISIBLE);
                    tag_05.setText(array.optJSONObject(4).optString("dangerName"));
                    tag_06.setText(array.optJSONObject(5).optString("dangerName"));
                }
            } else if (i >= 6 && i < 9) {
                lin_one_line.setVisibility(View.VISIBLE);
                lin_two_line.setVisibility(View.VISIBLE);
                ...
                tag_05.setText(array.optJSONObject(4).optString("dangerName"));
                tag_06.setText(array.optJSONObject(5).optString("dangerName"));
                tag_07.setText(array.optJSONObject(6).optString("dangerName"));
                if (i == 7) {
                    lin_eight.setVisibility(View.VISIBLE);
                    tag_08.setText(array.optJSONObject(7).optString("dangerName"));
                } else if (i == 8) {
                    lin_eight.setVisibility(View.VISIBLE);
                    lin_nine.setVisibility(View.VISIBLE);
                    tag_08.setText(array.optJSONObject(7).optString("dangerName"));
                    tag_09.setText(array.optJSONObject(8).optString("dangerName"));
                }
            }
