 ...
 */
 ...
 public  class Act_Rcjdreply extends BaseActivity {
    ...
    public void initAlert(){
        new ActionSheetDialog(Act_Rcjdreply.this)
                .builder()
                .setCancelable(false)
    ...
    public void PictureSelector(){
        PictureSelector.create(Act_Rcjdreply.this).openGallery(PictureMimeType.ofImage())
                .maxSelectNum(9)
                .imageSpanCount(4)
    ...
    public void PictureCarmerSelector(){
        PictureSelector.create(Act_Rcjdreply.this).openCamera(PictureMimeType.ofImage())
                .maxSelectNum(9)
                .imageSpanCount(4)
                .selectionMode(PictureConfig.MULTIPLE)
                .previewImage(true)
                ...
                for (int i = 0; i < baseQuickAdapter.getData().size()-1; i++) {
                    ...
                    if(selectTag == 1){
                        if(TextUtils.isEmpty(xPoint) && TextUtils.isEmpty(yPoint)){
                            Bitmap bitmap = SendImageUtil.createWatermark(Act_Rcjdreply.this,
    ...
    public void initListener() {
        commit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                loadingDialog.show();
                postJsonDate(object.toString(),files,"EditDaySuperviseManage_Reply");
            }
        });
    }
    ...
    public void getLocation(){
        Location location = LocationUtils.getInstance(Act_Rcjdreply.this ).showLocation();
        if (location != null) {
