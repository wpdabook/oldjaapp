...
public class Act_JygzAddRecord extends BaseActivity {
    ...
    EditText edit_des;
    @BindView(R.id.addrecord_recyclerView)
    ...
    public int getLayoutId() {
        return R.layout.act_jygzadd_record;
    }
    ...
    public  void postData(){
        ...
        try {
                ...
                if(path != null){
                    if(selectTag == 1){
                        if(TextUtils.isEmpty(xPoint) && TextUtils.isEmpty(yPoint)){
                            Bitmap bitmap = SendImageUtil.createWatermark(Act_JygzAddRecord.this,
            ...
            jsonObject.put("remark",edit_des.getText().toString());
        ...
        if("com.a21zhewang.constructionapp3".equals(AppUtils.getPackageName(getApplicationContext()))
            ...
            XUtil.updatas(jsonObject, imgs, "AddBroadCastNoticeRect", callback);
        }else {
            XUtil.updatassj(jsonObject, imgs, "AddBroadCastNoticeRect", callback);
        }
    }
    public void initAlert(){
        new ActionSheetDialog(Act_JygzAddRecord.this)
                .builder()
                .setCancelable(false)
    ...
    public void getLocation(){
        Location location = LocationUtils.getInstance(Act_JygzAddRecord.this ).showLocation();
        if (location != null) {
