...
import com.a21zhewang.constructionapp.utils.Act_BaseListView3;
...
public class Act_Rcjd extends Act_BaseListView3<JdzfType.JdzfStatus, JdzfType.MsgStatusBean, RecordDate> {
    ...
    private void getspinnerdata() {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"type\":\"lawTypes\"}"), "GetDaySuperviseManageTypes", new MyCallBack() {
            @Override
    ...
    private void getlistdata(int pageIndex,int pageSize,String lawType,String lawStatus) {
        ...
        XUtil.postjsondata(getjsonobj, "GetDaySuperviseManageList", new MyCallBack() {
            @Override
            public void onResule(String res) {
                try {
...
//                holder.setTextColor(R.id.gtxt_list_item_tv_msgStatus,Integer.parseInt(color_str));
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Act_Rcjd.this, Act_RcjdDetail.class);
    ...
    public void setaddbtnonclick() {
        activityBaselistviewRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onClickIndex=0;
                startActivity(new Intent(Act_Rcjd.this,Act_RcjdAddInfo.class));
            }
        });
    }
    ...
    public void resume() {
        ...
        if (0 != PushMessageReceiver.count) {
            ...
            AppShortCutUtil.setCount(PushMessageReceiver.count, Act_Rcjd.this);
        }
    }
}
