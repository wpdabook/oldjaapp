...
public class Act_Focus extends BaseActivity{
    ...
    //    List<String> tabTitles = new ArrayList<>(Arrays.asList("重点检查","整改率","危大工程"));
...
//                        circularProgressView1.setText("整改",getPercentage(a,leveobject.optInt("num"))+"%");
...
//                    values.add(new SliceValue()); //安全
//                    values.add(new SliceValue(object.optInt("qualityCount"),
//                            getResources().getColor(R.color.pie_zi))); //质量
//                    values.add(new SliceValue(object.optInt("civilizedCount"),
//                            getResources().getColor(R.color.pie_green)));  //文明
...
//                            getResources().getColor(R.color.pie_blue))); //安全
