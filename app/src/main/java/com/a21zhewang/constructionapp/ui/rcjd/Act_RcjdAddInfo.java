...
public class Act_RcjdAddInfo extends BaseActivity {
    ...
    public void initAlert(){
        new ActionSheetDialog(Act_RcjdAddInfo.this)
                .builder()
                .setCancelable(false)
    ...
    private void postdata() {
                ...
                if(path != null){
                    if(selectTag == 1){
                        if(TextUtils.isEmpty(xPoint) && TextUtils.isEmpty(yPoint)){
                            Bitmap bitmap = SendImageUtil.createWatermark(Act_RcjdAddInfo.this,
        ...
        XUtil.updatas(jsonObject, imgs, "EditDaySuperviseManage", callback);
    }
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Act_RcjdSelectType.RESQUST_CODE_SELECTTYPE
                && resultCode == RESULT_OK
                && data != null) {
        ...
        if (requestCode == Act_RcjdSelectCompany.RESQUST_CODE_SELECTCOMPANY
                && resultCode == RESULT_OK
                && data != null) {
            String strs = data.getStringExtra("strs");
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.li_select_project:
                XUtil.postjsondata(JsonUtils.getjsonobj("{\"type\":\"projects\"}"), "GetDaySuperviseManageTypes", new MyCallBack() {
                    @Override
                    public void onResule(String res) {
                        ...
                        if (projectList != null && projectList.size() > 0) {
                            Intent intent = new Intent(Act_RcjdAddInfo.this, SelectProjectActivity.class);
            ...
            case R.id.li_select_type:
                startActivityForResult(new Intent(Act_RcjdAddInfo.this,Act_RcjdSelectType.class),Act_RcjdSelectType.RESQUST_CODE_SELECTTYPE);
                break;
            case R.id.li_select_companys:
                startActivityForResult(new Intent(Act_RcjdAddInfo.this,Act_RcjdSelectCompany.class)
                        .putExtra("projectId",projectId),Act_RcjdSelectCompany.RESQUST_CODE_SELECTCOMPANY);
                break;
...
//                break;
    ...
    public void getLocation(){
        Location location = LocationUtils.getInstance(Act_RcjdAddInfo.this ).showLocation();
        if (location != null) {
