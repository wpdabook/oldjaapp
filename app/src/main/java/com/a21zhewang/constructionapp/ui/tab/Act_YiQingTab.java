...
/**
 * Created by wp-pc on 2020/4/1.
 */

public class Act_YiQingTab extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.act_yiqingtab_layout;
    }
    ...
    public void initViews() {
        ...
        list.add(new StartAndResumeFragment() );
        list.add(new ManagementNumberFragment() );
        list.add(new MechanicalEquipmentFragment());
        bottomlist.add(new MemberInfoFragment());
        bottomlist.add(new EquipmentInfoFragment());
        bottomlist.add(new DangerFragment());
        TopAdapter = new TabFragmentPagerAdapter(getSupportFragmentManager(), list);
        bottomAdapter = new TabFragmentPagerAdapter(getSupportFragmentManager(), bottomlist);
        ...
        listadapter = new MyBaseAdapter() {
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                if (view == null) {
                    view = getLayoutInflater().inflate(R.layout.act_yiqingtab_list_item, null);
                }
                ...
                report_number.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(Act_YiQingTab.this,Act_ReportProject.class).putExtra("type",2).putExtra("title","已上报项目信息"));
                    }
                });
                no_report_number.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        startActivity(new Intent(Act_YiQingTab.this,Act_ReportProject.class).putExtra("type",1).putExtra("title","未上报项目信息"));
                    }
                });
...
//                    tv_one.setText("较昨日"+"+"+object.optInt("projectCountDiff"));
        ...
        public void onPageSelected(int arg0) {
            switch (arg0) {//状态改变时底部对应的字体颜色改变
                ...
                case 1:
                    ...
                    lin_two.setBackgroundColor(getResources().getColor(R.color.table_line));
                    lin_three.setBackgroundColor(getResources().getColor(R.color.white));
                    ((ManagementNumberFragment) list.get(1)).initData();
                    break;
                case 2:
                    lin_one.setBackgroundColor(getResources().getColor(R.color.white));
                    lin_two.setBackgroundColor(getResources().getColor(R.color.white));
                    lin_three.setBackgroundColor(getResources().getColor(R.color.table_line));
                    ((MechanicalEquipmentFragment) list.get(2)).initData();
                    break;
            }
