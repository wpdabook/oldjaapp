...
public class Act_DxzfDetail extends BaseActivity {
...
//                        .putExtra("createUserName",jdzfBeanDetail.getCreateName()));
                startActivityForResult(new Intent(Act_DxzfDetail.this,Act_Dxreply.class)
                        .putExtra("id",jdzfBeanDetail.getId())
                        .putExtra("proShortName",jdzfBeanDetail.getProjectName())
                        .putExtra("createUserName",jdzfBeanDetail.getCreateName())
                        ,Act_Dxreply.RESQUST_CODE_REPLY);
            }
        });
...
//                        PublicUtils.call(item.getUserId(),Act_JdzfDetail.this);
                        PublicUtils.call("",Act_DxzfDetail.this);
                    }
                });
            }
        };
        ...
        imgsAdapter = new CommonAdapter<FileBean>(this, R.layout.act_jdzfdetail_imgitem, imgfiles) {
            ...
            protected void convert(com.zhy.adapter.recyclerview.base.ViewHolder holder, FileBean fileBean, final int position) {
                ...
                Glide.with(Act_DxzfDetail.this).load(fileBean.getUrl()).into(imageView);
                holder.setOnClickListener(R.id.faqigtxt_imglist_item_img, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PhotoViewActivity.statPhotoViewActivity(Act_DxzfDetail.this, position, imgfiles, pagerAdapterAPI);
                    }
                });
            }
        };
        ...
        reply_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Act_DxzfDetail.this,Act_ReplyDetail.class).putExtra("id",jdzfBeanDetail.getId()));
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == Act_Dxreply.RESQUST_CODE_REPLY && data != null) {
            getDate();
        }
    }
    ...
    public void getDate(){
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"id\":\"" + id + "\",\"readUserId\":\"" + PublicUtils.UserID + "\"}"), "EditSuperviseManage", new MyCallBack() {
            @Override
            public void onResule(String res) {
                getdate();
            }
    ...
    public void getdate() {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"id\":\"" + id + "\"}"), "GetSuperviseManageDetail", new MyCallBack() {
            @Override
            public void onResule(String res) {
...
//                zf_company_name.setText(jdzfBeanDetail.getConManager());
                ...
                replyAdapter = new CommonAdapter<ItemFileList>(Act_DxzfDetail.this, R.layout.act_jdzfdetail_imgitem, replyFilesList) {
                    ...
                    protected void convert(com.zhy.adapter.recyclerview.base.ViewHolder holder, ItemFileList fileBean, final int position) {
                        ...
                        holder.setOnClickListener(R.id.faqigtxt_imglist_item_img, new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                PhotoViewActivity.statPhotoViewActivity(Act_DxzfDetail.this, position, replyFilesList, pagerAdapterAPI);
                            }
                        });
                    }
                };
