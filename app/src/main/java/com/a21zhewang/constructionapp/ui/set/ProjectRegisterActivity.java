...
//        }
        ...
        if("com.a21zhewang.constructionapp3".equals(AppUtils.getPackageName(getApplicationContext()))
            ...
            XUtil.postjsondata(comitObject, "AddBroadCastProject", callback);
        }else {
            XUtil.postjsondatasj(comitObject, "AddBroadCastProject", callback);
        }
    }
...
//            comitObject.put("area",Area); // 地图获取的区
    ...
    public void loadProjectType(){
        ...
        if("com.a21zhewang.constructionapp3".equals(AppUtils.getPackageName(getApplicationContext()))
                || "com.a21zhewang.constructionapp.cqjg".equals(AppUtils.getPackageName(getApplicationContext()))){
            XUtil.postjsondata(object, "GetBroadCastProjectType", callback);
        }else {
            XUtil.postjsondatasj(object, "GetBroadCastProjectType", callback);
        }
    }
    /**
     * 安全负责人所属单位选择
