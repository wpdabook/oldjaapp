...
public class Act_TaskCheck extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.act_taskcheck_layout;
    }
...
//        }
        ...
        loadingDialog.show();
        XUtil.postjsondatasj(jsonObject,"AddTaskSuperviseDetail", callback);
    }
    @Override
