...
//            loadData(true,sortType,unit);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (v == null) {
            v = inflater.inflate(R.layout.layout_totalrank_layout, null, false);
                ...
                public View getView(int position, View arg1, ViewGroup parent) {
                    ...
                    if (arg1 == null) {
                        arg1 = getActivity().getLayoutInflater().inflate(
                                R.layout.total_rank_fragment, null);
                    }
                    ...
                    TextView score = MViewHolder.get(arg1, R.id.score);
...
//                        add.setText("重点检查完成率：" + number);
                        ...
                        score.setText(df.format(object.optDouble("sore"))+"分");
                        if("1".equals(id)){
                            rank_search_lin1.setVisibility(View.VISIBLE);
                            rank_search_lin2.setVisibility(View.GONE);
                            rank_search_lin3.setVisibility(View.GONE);
                            rank_search_lin4.setVisibility(View.GONE);
//                            end.setText(object.optString("dicName"));
                            end.setText("工程类型：房建工程");
                        }
                        if("2".equals(id)){
                            rank_search_lin1.setVisibility(View.GONE);
                            rank_search_lin2.setVisibility(View.VISIBLE);
                            rank_search_lin3.setVisibility(View.GONE);
                            rank_search_lin4.setVisibility(View.GONE);
                        }
                        if("3".equals(id)) {
                            rank_search_lin1.setVisibility(View.GONE);
                            rank_search_lin2.setVisibility(View.GONE);
                            rank_search_lin3.setVisibility(View.VISIBLE);
                            rank_search_lin4.setVisibility(View.GONE);
                        }
                        if("4".equals(id)){
                            rank_search_lin1.setVisibility(View.GONE);
