...
public class ToDoAdapter extends ClassAdapter<ToDoAdapter.ClassHolder, ToDoAdapter.StudentHolder> {
    ...
    public ToDoAdapter(Context context, List mContent) {
     ...
     */
    @Override
    public ToDoAdapter.ClassHolder onCreateHeaderViewHolder(ViewGroup parent, int viewType) {
     ...
     */
    @Override
    public ToDoAdapter.StudentHolder onCreateContentViewHolder(ViewGroup parent, int viewType) {
        return new StudentHolder(mInflater.inflate(R.layout.item_todo_content, parent, false));
    }

    @Override
    public void onBindHeaderViewHolder(ToDoAdapter.ClassHolder holder, int position) {
