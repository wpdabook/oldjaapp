...
public class CheckItemAdapter <T extends CheckType> extends BaseMultiItemQuickAdapter<T, BaseViewHolder> {
    /**
    ...
    public CheckItemAdapter(Context context,List<T> data) {
        super(data);
        openLoadAnimation();
       // isFirstOnly(false);
