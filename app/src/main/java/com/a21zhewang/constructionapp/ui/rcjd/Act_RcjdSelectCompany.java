...
public class Act_RcjdSelectCompany extends BaseActivity implements View.OnClickListener,AdapterView.OnItemClickListener {
...
//                data.putExtra("strs",sb.toString());
    ...
    public void initData() {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"type\":\"companys\",\"projectId\":\"" + projectId + "\"}"), "GetDaySuperviseManageTypes", new MyCallBack() {
            @Override
            public void onResule(String res) {
                jdzfCompanysBean = JsonUtils.getbean(res,JdzfCompanysBean.class);
                jdzfCompanysList = jdzfCompanysBean.getBackdata();
                adapter = new MyDXCompanyAdapter(Act_RcjdSelectCompany.this, jdzfCompanysList);
