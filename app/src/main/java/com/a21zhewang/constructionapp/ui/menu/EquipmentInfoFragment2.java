...
public class EquipmentInfoFragment2 extends BaseLazyFragment {
    ...
    public View initView(LayoutInflater inflater, @Nullable ViewGroup container) {
        View view = inflater.inflate(R.layout.equipment_info_fragment, container, false);
        ...
        adapter = new MyBaseAdapter() {
            ...
            public View getView(int position, View view, ViewGroup parent) {
                ...
                if (view == null) {
                    view = getActivity().getLayoutInflater().inflate(R.layout.member_info_fragment_item3, null);
                }
                ...
                if(object.length()>0){
                    ...
                    yq_manger.setText(object.optInt("equipmentCount")+"");
                    yq_work_member.setText(object.optInt("yesEquipmentCount")+"");
                    yq_normal.setText(object.optInt("noEquipmentCount")+"");
                }
        ...
        more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(),Act_YiQingTabMore.class).putExtra("type",2).putExtra("title","项目机械设备信息"));
            }
        });
    ...
    protected void loadData() {
        XUtil.postjsondata(JsonUtils.getjsonobj("{\"type\":\"" + "2" + "\",\"dateTime\":\"" + DateUtils.getTodayDate() + "\"" +
