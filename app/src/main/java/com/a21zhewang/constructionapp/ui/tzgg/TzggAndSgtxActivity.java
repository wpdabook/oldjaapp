...
public abstract class TzggAndSgtxActivity extends BaseActivity implements OnTouchUpListener {
                ...
                if (btn.getBtnID().equals(setaddimgisvisiable())) {
                    ...
                    activityTzggImageViewAddimg.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            onClickIndex=0;
                            Intent intent = new Intent(TzggAndSgtxActivity.this, AddTzggActivity.class);
                            intent.putExtra("typeID", setmethod());
...
//                if (!setmethod().equals("notice2")) {
//                    holder.setText(R.id.sgtx_list_item_tv_bt, tzgglistBean.getTitle());
//                    holder.setText(R.id.sgtx_list_item_tv_nr, tzgglistBean.getContent());
//                    holder.setText(R.id.sgtx_list_item_tv_tsr, "发送人:" + tzgglistBean.getCreateUserName());
//                    holder.setText(R.id.sgtx_list_item_tv_dw, tzgglistBean.getEtpShortName());
//                    holder.setText(R.id.sgtx_list_item_tv_time, tzgglistBean.getCreateTime());
//                    if (tzgglistBean.getRead()) {
//                        holder.setBackgroundColor(R.id.sgtx_list_item_tv_isread, Color.parseColor("#ffffff"));
//
//                    } else {
//                        holder.setBackgroundRes(R.id.sgtx_list_item_tv_isread, R.drawable.sgtx_list_item_shape);
//                    }
//                } else {
                    holder.setText(R.id.tzgg_list_item_tv_title, tzgglistBean.getTitle());
                    holder.setText(R.id.tzgg_list_item_tv_from, tzgglistBean.getEtpShortName() +" "+ tzgglistBean.getCreateUserName());
                    holder.setText(R.id.tzgg_list_item_tv_time, tzgglistBean.getCreateTime());
                    if (tzgglistBean.getRead()) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(TzggAndSgtxActivity.this, TzggxqActivity.class);
                        intent.putExtra("recordID", tzgglistBean.getRecordID());
                        if (setmethod().equals("notice2")) {
                            intent.putExtra("title", "通知公告");

                        } else {
                            intent.putExtra("title", "施工提醒");
    ...
    private void getdata(int pageindex,int pageSize) {
        JSONObject getjsonobj = JsonUtils.getjsonobj("{\"pageIndex\":\"" + pageindex + "\",\"typeID\":\"" + setmethod() + "\",\"keyWord\":\"" + keyWord+ "\",\"pageSize\":\""+pageSize+"\"}");
