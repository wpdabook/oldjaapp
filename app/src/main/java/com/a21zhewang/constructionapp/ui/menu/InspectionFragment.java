...
public class InspectionFragment extends BaseLazyFragment{
    ...
    public static InspectionFragment getInstance(String title) {
        InspectionFragment sf = new InspectionFragment();
        sf.mTitle = title;
        return sf;
    }
    @Override
    public View initView(LayoutInflater inflater, @Nullable ViewGroup container) {
        View v = inflater.inflate(R.layout.act_customtab_inspection, null);
