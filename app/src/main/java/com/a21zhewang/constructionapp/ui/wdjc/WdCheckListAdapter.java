...
public class WdCheckListAdapter<T extends CheckType> extends BaseMultiItemQuickAdapter<T, BaseViewHolder> {
     ...
     */
    public WdCheckListAdapter(Context context, List<T> data, Project pj) {
        super(data);
        this.pj=pj;
        ...
        switch (item.getItemType()) {
            ...
            case LEVEL_TWO:
                ...
                checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                     ...
                     //   PublicUtils.toast("是否勾选：" + checked);
                        ...
                        WdSetCheckListActivity.checkType = item;
                        if (childList != null) {
                ...
                helper.getView(R.id.setchecklist_level1_item_pz).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        WdSetCheckListActivity.checkType = item;
                        Intent intent = new Intent(mContext, WdSetCheckChildActivity.class);
...
//                }
    ...
    private void getlistdata() {
        if (WdSetCheckListActivity.checkType==null)return;
        if (WdSetCheckListActivity.checkType.getCheckItemList()!=null)return;
        JSONObject getjsonobj = JsonUtils.getjsonobj("{\"checkItemList\":[{\"dicID\":\"" + WdSetCheckListActivity.checkType.getDicID() + "\"}],\"projectID\":\""+pj.getProjectID()+"\"}");
