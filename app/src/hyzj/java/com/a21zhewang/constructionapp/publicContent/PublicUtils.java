...
public class PublicUtils {
   ...
   //=================================常用链START=====================================================//
      ...
      public  static String URLload="https://safe-hy.telsafe.com.cn:8100";//全局urL
      public  static String URL= URLload + "/API/SGGL.aspx";//全局url
      public  static Boolean IS_DEBUG_MODE = false;    //调试模式设置
      public  static String ALIAS="HYZJ_";
      /**部分模块切换市局服务器*/
      ...
      /**汉阳建安正式*/
//      public  static String HTMLURL="http://106.15.92.195:9002";
//      public  static String URLload="https://wuhan.21theone.cn:8100";//全局urL
//      public  static String URL= URLload + "/API/SGGL.aspx";//全局url
//      public  static Boolean IS_DEBUG_MODE = false;    //调试模式设置
//      public  static String ALIAS="HYZJ_";
