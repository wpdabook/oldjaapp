...
public class PublicUtils {
    ...
    //=================================常用链START=====================================================//
     ...
     /**琴台建安正式*/
      ...
      public  static String URLload="https://data-cjqt.telsafe.com.cn:9001";//全局urL
      public  static String URL=URLload+"/API/SGGL.aspx";//全s局url
      public  static Boolean IS_DEBUG_MODE = false;    //调试模式设置
      public  static String ALIAS="QT_";
      /**部分模块切换市局服务器*/
