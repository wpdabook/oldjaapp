package com.a21zhewang.mytoast;
...
public class BToast extends Toast {
    ...
    private static void initToast(Context context, CharSequence text) {
        try {
            ...
            JumpingBeans jumpingBeans2 = JumpingBeans.with(toast_text)
                    .makeTextJump(0, toast_text.getText().length())
                    .setIsWave(true)
                    .setLoopDuration(1000).setWavePerCharDelay(100)
                    .build();
