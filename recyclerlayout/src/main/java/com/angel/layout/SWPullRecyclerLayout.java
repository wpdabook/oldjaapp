...
public class SWPullRecyclerLayout extends LinearLayout implements NestedScrollingParent {
    ...
    private TextView headertv;//刷新文字
    private TextView footertv;//刷新文字
    ...
    private void inital() {
        ...
        addView(this.header, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
