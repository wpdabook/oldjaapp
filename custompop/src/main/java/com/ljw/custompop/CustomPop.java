...
public class CustomPop implements PopupWindow.OnDismissListener{
    ...
    private CustomPop(Context context){
        mContext = context;
    }
     ...
     * @return
     */
    public CustomPop showAsDropDown(View anchor, int xOff, int yOff){
    ...
    public CustomPop showAsDropDown(View anchor){
        if(mPopupWindow!=null){
            hei();
...
//    }
    ...
    public CustomPop showAsDropDown(View anchor, int xOff, int yOff, int gravity){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public CustomPop showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
            hei();
...
//        }
    ...
    public static class PopupWindowBuilder{
        private CustomPop mCustomPopWindow;

        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new CustomPop(context);
        }
        ...
        public PopupWindowBuilder setBgDrawable(Drawable bgDrawable){
            mCustomPopWindow.bgDrawable = bgDrawable;
            return this;
        }
        public PopupWindowBuilder setBgDrawable(){
            mCustomPopWindow.bgDrawable =mCustomPopWindow.mContext.getResources().getDrawable(R.drawable.bg_droplist_shape) ;
            return this;
        }
        ...
        public CustomPop create(){
            //构建PopWindow
            mCustomPopWindow.build();
            return mCustomPopWindow;
        }

        public PopupWindowBuilder getRecyclerView(RecyclerView.Adapter adapter,RecyclerView.ItemDecoration itemDecoration){
            RecyclerView recyclerView = new RecyclerView(mCustomPopWindow.mContext);
            recyclerView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
            recyclerView.setLayoutManager(new LinearLayoutManager(mCustomPopWindow.mContext));
            recyclerView.setAdapter(adapter);
            recyclerView.addItemDecoration(itemDecoration);
            return setView(recyclerView);
        }
